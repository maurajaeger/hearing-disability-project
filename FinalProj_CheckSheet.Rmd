...
(A) .Rmd Line numbers where at least two different data sources are imported:  27, 144/146-149


(B) .Rmd Line numbers for inspecting data intake:  31, 158
...
(A) .Rmd Line number(s) for general data wrangling: 52-58, 93-104, 165-167, 187-191


(B) .Rmd Line number(s) for a join operation: 177


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 99, 188-189


(D) .Rmd Line number(s) for use of regular expressions: 38, 112


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 167, 191
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  77, 78, 124, 208

(B) .Rmd Line number(s) for use of multiple aesthetics:  76-78, 207-210

(C) .Rmd Line number(s) for use of layered graphics:  75-83
